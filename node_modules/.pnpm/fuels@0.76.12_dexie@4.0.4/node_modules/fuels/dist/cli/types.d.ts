...
export type FuelsConfig = UserFuelsConfig & Required<Pick<UserFuelsConfig, 'contracts' | 'predicates' | 'scripts' | 'deployConfig' | 'useBuiltinForc' | 'useBuiltinFuelCore' | 'autoStartFuelCore' | 'providerUrl' | 'forcBuildFlags'>> & {
    basePath: string;
    configPath: string;
