...
var InputMessageCoder = class extends import_abi_coder3.Coder {
  ...
  static getMessageId(value) {
    ...
    return (0, import_ethers.sha256)((0, import_utils2.concat)(parts));
  }
...
var ReceiptMessageOutCoder = class extends import_abi_coder6.Coder {
  ...
  static getMessageId(value) {
    ...
    return (0, import_ethers2.sha256)((0, import_utils5.concat)(parts));
  }
  encode(value) {
    const parts = [];
...
var getAssetId = (contractId, subId) => {
  ...
  return (0, import_ethers2.sha256)((0, import_utils5.concat)([contractIdBytes, subIdBytes]));
};
