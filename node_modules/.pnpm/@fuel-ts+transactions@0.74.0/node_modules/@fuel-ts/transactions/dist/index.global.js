...
(() => {
  ...
  var U64Coder = class extends Coder {
    ...
    encode(value) {
      let bytes2;
      try {
        bytes2 = toBytes(value, WORD_SIZE);
      } catch (error) {
  ...
  var NumberCoder = class extends Coder {
    ...
    decodeU8(data, offset) {
      ...
      return [toNumber2(bytes2), offset + this.paddingLength];
    }
    decode(data, offset) {
  ...
  __publicField2(StdStringCoder, "memorySize", 1);
  ...
  __publicField2(ByteCoder2, "memorySize", 1);
  ...
  __publicField2(StdStringCoder2, "memorySize", 1);
