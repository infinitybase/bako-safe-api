...
import type { SchemaPredicateBalance } from "../../../utils/mongo";
import { ETH } from "../constants";
import type { PredicateBalanceGrouped } from "../types";


export async function makeDeposits(tx_grouped: PredicateBalanceGrouped, predicate_address: string): Promise<SchemaPredicateBalance[]> {
